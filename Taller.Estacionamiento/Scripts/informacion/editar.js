...
$(document).ready(function  () {
	...
	$("#24hrs-check").change(function  () {
		var check = $(this);
		if (check.is(':checked')) {
      console.log("checked");
      $("#form-field-mask-4").attr("disabled", "disabled");
      $("#form-field-mask-5").attr("disabled", "disabled");
    } else {
    	$("#form-field-mask-4").removeAttr("disabled");
      $("#form-field-mask-5").removeAttr("disabled");
